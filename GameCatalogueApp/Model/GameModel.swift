...
// MARK: - Filters
struct FiltersGame: Codable {
    let years: [FiltersYearGame]?
}

// MARK: - FiltersYear
struct FiltersYearGame: Codable {
    let from, to: Int?
    let filter: String?
    let decade: Int?
    let years: [YearYearGame]?
    let nofollow: Bool?
    let count: Int?
}

// MARK: - YearYear
struct YearYearGame: Codable {
    let year, count: Int?
    let nofollow: Bool?
}
